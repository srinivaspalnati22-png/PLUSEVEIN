...
def analyze_audio_fake(
    ...
    try:
        ...
        return AudioFakeResult(
            ...
            zcr_variance=0.0,
            synthetic_prob=0.1,
            finding="Silent video stream / no vocal audio track. No synthetic vocoder artifacts detected.",
            confidence=0.5,
        )
    ...
    if len(y) < 8000:
        return AudioFakeResult(
            ...
            zcr_variance=0.0,
            synthetic_prob=0.1,
            finding="Audio track duration too short for synthetic voice acoustic analysis.",
            confidence=0.5,
        )
